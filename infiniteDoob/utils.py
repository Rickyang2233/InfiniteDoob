...
def gradx(f: callable):
    """ Calculate the gradient of a manifold-valued scalar field f with respect to the component of point q on manifold

    Args:
        f (callable): A manifold-valued scalar field f

    Returns:
        gradf (callable): The gradient of f with respect to the component of point q on manifold
    """
    def fxchart(x,chart,*args,**kwargs):
        """ A manifold-valued scalar field f taking coordinates and chart """
        return f((x,chart),*args,**kwargs)
    
    def gradf(x,*args,**kwargs):
        """ The gradient of f with respect to the component of point q on manifold """
...
def jacfwdx(f: callable):
    """ Calculate the Jacobian of a manifold-valued vector field f with respect to the component of point q on manifold

    Args:
        f (callable): A manifold-valued vector field f
    
    Returns:
        jacf (callable): The Jacobian of f with respect to the component of point q on manifold
    """
    def fxchart(x,chart,*args,**kwargs):
        """ A manifold-valued vector field f taking coordinates and chart"""
        return f((x,chart),*args,**kwargs)
    
    def jacf(x,*args,**kwargs):
        """ The Jacobian of f with respect to the component of point q on manifold"""
